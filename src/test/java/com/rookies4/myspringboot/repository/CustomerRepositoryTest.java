...
class CustomerRepositoryTest {
    ...
    void testNotFoundCustomer() {
        Customer notFundCustomer = customerRepository.findByCustomerId("AC003").orElseThrow(() -> new RuntimeException("Customer Not Found"));
    }
    ...
    void testFindCustomer() {
        ...
        //Optinal의 T orElesGet(Supplier) 고객번호(AC001)가 존재하는 경우
        Optional<Customer> customerByCustomerId = customerRepository.findByCustomerId("AC001");
        Customer ac001Cuyomer = customerByCustomerId.orElseGet(() -> new Customer());
        assertThat(ac001Cuyomer.getCustomerName()).isEqualTo("스프링부트");
    ...
    void testSaveCustomer() {
        ...
        //등록된 Customer Name 값이 동일한지 검증하기
