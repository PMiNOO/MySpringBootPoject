...
//Appllication 클래스가 Configuration(설정) 클래스 역할을 한다. @SpringBootApplication
//반드시 해당 클래스를 작성할떄 base-package 아래에 작성을 해야한다. @ComponentScan
//외부라이브러리에 대한 설정기능을 제공하는 AutoConfiguration @EnableAutoConfiguration
